...
def train(model, device, config, epochs=5, batch_size=1, save_cp=True, log_step=20, img_scale=0.5):
    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img', ncols=50) as pbar:
            ...
            eval_model = Yolov4(None, n_classes=cfg.classes, inference=True)
            ...
            logging.info(f'train/AP {stats[0]} {global_step}')
            logging.info(f'train/AP50 {stats[1]} {global_step}')
            logging.info(f'train/AP75 {stats[2]} {global_step}')
            logging.info(f'train/AP_small {stats[3]} {global_step}')
            logging.info(f'train/AP_medium {stats[4]} {global_step}')
            logging.info(f'train/AP_large {stats[5]} {global_step}')
            logging.info(f'train/AR1 {stats[6]} {global_step}')
            logging.info(f'train/AR10 {stats[7]} {global_step}')
            logging.info(f'train/AR100 {stats[8]} {global_step}')
            logging.info(f'train/AR_small {stats[9]} {global_step}')
            logging.info(f'train/AR_medium {stats[10]} {global_step}')
            logging.info(f'train/AR_large {stats[11]} {global_step}')
